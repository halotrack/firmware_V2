...
#define CONFIG_I2CDEV_TIMEOUT 1000  // 1 second timeout
...
/**
 * @name Macros utilitarios para manejo de mutex y chequeo de errores
 * @{ 
 * Estos macros ayudan a simplificar el manejo de errores y mutex en las operaciones I2C.
 */
